    ...
    <>
      ...
      <section className="py-16 bg-gray-50 p-[10px] ">
        <div className="container p-4  mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="w-full  flex flex-col  gap-4">
            <h3 className="text-2xl md:text-4xl font-bold text-center">
              Discover the Power of Pure Shilajit
            </h3>
            <p className="text-sm text-gray-600 leading-relaxed">
              At ShaastraYog, we bring you the finest quality Shilajit, sourced
              from the pristine Himalayan mountains. Our premium Shilajit is
              rich in essential minerals, fulvic acid, and bioactive compounds
              that support your overall well-being. Experience enhanced energy,
              vitality, and natural balance with our authentic, pure Shilajit
              supplements. Join thousands of satisfied customers who have
              discovered the ancient wisdom of this remarkable natural
              substance.
            </p>
            <div className="flex justify-center ">
              <Button size="lg" asChild>
